<div align="center">
   <h3 align="center">RHGPT - A customized AI chat platform </h3>
  <br />
    <a href="https://rh-gpt.vercel.app/" target="_blank">
      <img src="client/src/assets/rhgpt.webp" alt="Project Banner" width="50%">
    </a>
  <br />
...
A customized AI chat platform powered by Gemini's generative models. It features a personalized user interface and enhanced chat functionalities, built to provide a more tailored AI interaction experience.
...
👉 **AI Chat**:Ask questions and receive intelligent responses.

👉 **Text-to-Image Generation**:Generate images using descriptive prompts.
...
```bash
git clone https://github.com/rezaHosseini98/RhGPT.git
cd RhGPT
```
...
IMAGEKIT_URL_ENDPOINT='https://ik.imagekit.io/rhgpt' add this way in ImageKit
#Gemini key
GEMINI_API_KEY=
```
